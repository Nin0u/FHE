...
std::tuple<mpz_class, mpz_class, mpz_class> get_di(Polynomial v, mpz_class prime, int deg);
...
std::tuple<Polynomial, mpz_class> invert_Polynomial(Polynomial v, Polynomial X, int max_prime);
